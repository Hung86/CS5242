...
#     model.add(VanillaRNN(in_features=50, units=32, initializer=Gaussian(std=0.01)))
...
#     model.add(Linear2D(vocab_size, 200, name='embedding', initializer=Gaussian(std=0.01)))
#     model.add(VanillaRNN(in_features=200, units=100, initializer=Gaussian(std=0.01)))
    
#     model.add(Linear2D(100, 200, name='linear1', initializer=Gaussian(std=0.01)))
#     model.add(VanillaRNN(in_features=200, units=64, initializer=Gaussian(std=0.01)))
    
#     model.add(Linear2D(64, 16, name='linear2', initializer=Gaussian(std=0.01)))
#     model.add(TemporalPooling()) # defined in layers.py
#     model.add(Linear2D(16, 2, name='linear3', initializer=Gaussian(std=0.01)))
